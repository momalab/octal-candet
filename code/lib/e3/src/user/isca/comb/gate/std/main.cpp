...
try
{
    ...
    if (tim)
    {
        ...
        //     FhewUint<2> t = _2_Fp;
        //     for ( auto g : gates )
        //         cout << names[int(g)] << " " << test<FhewBit>( g, t[0], t[1], tim ) << '\n';
        // }
        ...
        cout << "\nSEAL\n";
        {
            SealUint<2> t = _2_Sp;
            for ( auto g : gates )
                cout << names[int(g)] << " " << test<SealBit>( g, t[0], t[1], tim ) << '\n';
        }
        ...
        //     TfheUint<2> t = _2_Tp;
        //     for ( auto g : gates )
        //         cout << names[int(g)] << " " << test<TfheBit>( g, t[0], t[1], tim ) << '\n';
        // }
